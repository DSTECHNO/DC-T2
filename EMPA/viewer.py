...
with logo_col1:
    ...
    <div style='text-align: center; padding: 10px;'>
        <a href='https://heatwise.eu' target='_blank'>
            <img src='https://github.com/DSTECHNO/HW-PILOTS/blob/main/EMPA/heatwise_logo.svg' 
...
with logo_col2:
    ...
    <div style='text-align: center; padding: 10px;'>
        <a href='https://dstechs.net/' target='_blank'>
            <img src='https://github.com/DSTECHNO/HW-PILOTS/blob/main/EMPA/dstech_logo.png' 
